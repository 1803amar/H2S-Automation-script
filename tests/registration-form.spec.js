...
test('Valid Login', async ({ page }) => {
    ...
    // login on development environment
    await page.goto('https://developmentvision.hack2skill.com/login');
    ...
    // Click on innovator dashboard from navbar
    await page.locator('[data-id="nav-menu-item-innovator-dashboard"]:visible').click();

    await page.locator('div').filter({ hasText: 'Product Evolution Review' }).first()
